...
The Experience and Projects cards use unique, locally stored images selected for relevance. Each image is linked from its card to its original source page.
...
| Tri-Nav | `assets/portfolio/project-tri-nav-autonomous-robot.png` | [Autonomous Mobile Robot AMR](https://commons.wikimedia.org/wiki/File:Autonomous_Mobile_Robot_AMR.png), CC BY 4.0 |
| Depth-Supervised NeRF | `assets/portfolio/project-depth-nerf-reconstruction.jpg` | [Reconstruction Arc3D](https://commons.wikimedia.org/wiki/File:Reconstruction_Arc3D.jpg), CC BY-SA 3.0 |
